...
# generated by wxGlade 0.6.5 on Tue Aug  7 22:13:23 2012
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_Auto = wx.Button(self, -1, "Periodic update")
        ...
        self.Bind(wx.EVT_BUTTON, self.OnClickAuto, self.button_Auto)
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.button_Auto, 0, 0, 0)
    ...
    def OnClickAuto(self, event):  # wxGlade: MyFrame.<event_handler>
        print "Event handler `OnClickAuto' not implemented!"
        event.Skip()
